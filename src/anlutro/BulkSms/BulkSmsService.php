...
*@var string
     ...
     */
    public function __construct($username, $password, $curl = null, $singleurl = null, $bulkurl = null)
	{
    ...
    {
        return new Sender\Single($this->username, $this->password, $this->curl, $this->singleurl);
	}
    ...
    {
        return new Sender\Bulk($this->username, $this->password, $this->curl, $this->bulkurl);
	}
}
